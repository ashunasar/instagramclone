        ...
        child: Column(
          ...
          children: [
            ...
            GridView(
              ...
              children: [
                PostWidget(width: width, imgUrl: "assets/images/posts (1).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (2).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (3).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (4).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (5).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (6).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (7).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (8).jpg"),
                PostWidget(width: width, imgUrl: "assets/images/posts (9).jpg"),
                PostWidget(
